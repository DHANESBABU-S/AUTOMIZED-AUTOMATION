...
#---------------------------------------------------------------------------------------------------#
heading = Label(app,text = 'FORGOT PASSWORD',font=('Times New Roman',25,'bold'),bg='#fc8400')
...
def register():
  if User_name_Entry.get()=='' or User_password_Entry.get()=='' or User_cpassword_Entry.get()=='' or User_name_Entry.get()=='NAME' or User_password_Entry.get()=='PASSWORD' or User_cpassword_Entry.get()=='CONFORM PASSWORD':
    messagebox.showerror('AUTOMATIZED AUTOMATION','ENTER INFORMATION FOR UPDATE...')
    ...
    if password == cpassword:
      try:
        ...
        w=file.write(str(r))
        messagebox.showinfo('AUTOMATIZED AUTOMATION','SUCESSFULLY PASSWORD UPDATED')
        clear()
      except:
        file=open('Y:\PROJECTS\AUTOMIZED AUTOMATION\WORK SPACE\Assts\data_center\data.txt','w')
...
#---------------------------------------------------------------------------------------------------#
#---------------------------------------------------------------------------------------------------#
registerbutton = Button(app,text  = 'UPDATE',bd=0,width=25,height=0,font=('Times New Roman',15),bg='#fd6f00',activebackground='#fd6f00',cursor='hand2',command=register)
registerbutton.place(x=315,y=380)
#---------------------------------------------------------------------------------------------------#
#---------------------------------------------------------------------------------------------------#
forgotbutton = Button(app,text  = 'Clear?',bd=0,font=('Times New Roman',13),bg='#fa0111',activebackground='#fa0111',activeforeground='#fa0111',cursor='hand2',command=clear)
